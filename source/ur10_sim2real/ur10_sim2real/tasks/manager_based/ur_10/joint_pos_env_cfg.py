...
from ur10_sim2real.tasks.manager_based.ur_10.reach_env_cfg import ReachEnvCfg
...
class UR10ReachEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        ...
        # self.rewards.joint_torque_stable.params["asset_cfg"].body_names = ["robot"]
        # override actions
        ...
        self.commands.ee_pose.ranges.pitch = (0*math.pi / 2, 0*math.pi / 2)
